...
public class TreeGenerator : MonoBehaviour
{
    ...
    public void gen()
    {
        ...
        seedInp();
        int basePolygon = Mathf.Max(3, _basePolygon);
        ...
        Mesh mesh = GenBranch(tree, basePolygon, startVertices, startUv, _trunkThickness, _floorHeight, _floorNumber, new Vector3(), Vector3.up, 0f, _distorsionCone, _roughness, _branchDensity, _recursionLevel);
